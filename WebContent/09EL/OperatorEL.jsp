...
<body>
	...
	*/
	...
	\${null+10 } : ${null+10 } <br/>
	<!-- 
		최초페이지를 실행했을 때에는 파라미터가 없으므로 0으로 간주되어 계산됨
		만약
			해당페이지?myNumber=20인 경우 결과 30으로 출력됨
			해당페이지?myNumber= 인 경우 0으로 갖누되어 10출력됨
			해당페이지?myNumber=삼 인경우 문자는 숫자로 변경불가하므로 에러발생됨
	 -->
	...
	null로 인식하게된다.
	JSP의 변수는 EL에서 사용할수 없는 이유는 EL은 4가지영역에 저장된
	...
	*/
	...
	<!-- 
	JSP코드에서 선언한 변수는 EL에서 사용해야 할 경우에는 JSTL의
