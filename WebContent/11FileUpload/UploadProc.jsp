...
<%
//한글깨짐처리(post로 폼값전송시 깨짐 부분 처리 때문)
...
/*
	만약 파일을 여려개 업로드 한다면 각각의 용량을 합친
	용량이 최대용량이 된다.
	Ex) 500Kb * 2 = 1000Kb
*/
int maxPostSize = 1024 * 5000; //파일 두개 합 5000kb이하
...
<body>
	...
	<ul>
		...
		<li>파일크기 : <%=(int)Math.ceil(mr.getFile("chumFile2").length()/1024.0) %>Kb
		</li>
		<li>이미지표현 : 
