...
1. page영역
	...
	사용한다.
*/
pageContext.setAttribute("pageNumber",1000);//인티저객체
pageContext.setAttribute("pageString","페이지영역에 지정한 문자열");
...
<body>
	...
	*/
	...
	<%--
		...
		포함된 후 컴파일되도록 include지시어를 사용하는 경우
